...
const NotFound: React.FC = () => {
  ...
  return (
    <div className="flex flex-col justify-evenly items-center h-[100vh] py-[10rem] ps-10 w-[80vw]">
        <img className="absolute top-0 left-0 -z-10 min-w-[100vw] min-h-[100vh] h-[100vh]" src={bg404} alt={"Error image"} />
        ...
        <Link to="/home" className="bg-theme text-2xl p-[1.2rem] m-[1rem] rounded-md text-white hover:bg-theme-hovd transition delay-250 ease-in-out">Go to Home</Link>
    </div>
  )
}
