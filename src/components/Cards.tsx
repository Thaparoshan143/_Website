            ...
            <div className="p-2 flex flex-row flex-wrap justify-evenly items-center">
                {
                    tools.map((item : string) => {
                        return <li key={item} className="m-2 p-2 min-w-[3rem] bg-theme-alt hover:bg-theme text-theme-w rounded-md text-little list-none transition-all duration-200 cursor-pointer">{item}</li>
                    })
                }
            </div>
