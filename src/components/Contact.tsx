...
const Contact = () => {
    ...
    return (
        <div
            className="min-h-[50vh] w-full flex md:flex-row flex-col justify-evently items-center text-theme-w bg-theme-w-alt"
            id="contact"
        >
            <div className="md:w-[35%] w-full h-full flex flex-col justify-center items-center">
                <span className="text-title md:text-heading py-8 w-full text-center text-theme-b captalize font-bold">
                    Want More Details?
                </span>
                <motion.a
            ...
            <div className="md:w-[65%] w-full h-[50vh] flex flex-col justify-evenly items-center">
                <span className="text-theme-b text-heading font-extrabold font-main-alt uppercase m-8 underline">
                    Get in Touch
                </span>
                <form
                    className="flex flex-col justify-evenly items-center w-full h-full xl:px-[10%] px-4"
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="bg-theme-b-alt text-theme-w p-2 px-4 font-bold rounded-xl hover:bg-theme-b"
                    >
                        Submit
                    </button>
                </form>
    ...
    return (
        <div className="m-2 flex flex-row justify-between items-center w-full text-theme-w">
            ...
            <input
                ...
                className={"p-2 w-[80%] rounded-md text-theme-b "}
            />
        </div>
    );
};
