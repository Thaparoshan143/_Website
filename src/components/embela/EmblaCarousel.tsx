                        ...
                        return (
                            <div key={title} className={"embla__slide py-4"}>
                                <img
                                    src={url}
                                    alt={title}
                                    className={"min-h-[18rem] max-w-[25rem] xl:max-w-[35rem] max-h-[22rem] xl:max-h-[30rem] mx-auto transition-all duration-300 ".concat(
                                        index == selectedIndex
                                            ? " shadow-xl "
                                            : " opacity-20  scale-75 "
                                    )}
        ...
        <div className="embla sm:w-[95%] w-[90%]">
                ...
                <div className="embla__container flex">
                    {subItem.map((props: IProjectSubItem, index: number) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={"embla_def__slide py-4".concat(
                                    index == selectedIndex
                                        ? " shadow-xl "
                                        : " opacity-20  scale-75 "
                                )}
            ...
            <div className="embla-thumbs">
                <div className="overflow-hidden" ref={emblaThumbsRef}>
                    <div className="embla-thumbs__container mt-10 w-full flex flex-row justify-evenly sm:text-note text-sm">
                        {subItem.map(
                            (props: IProjectSubItem, index: number) => {
                                return (
                                    <Thumb
                                        key={index}
                                        onClick={() => onThumbClick(index)}
